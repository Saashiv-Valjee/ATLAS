...
void myPlotter(){
	...
	string path = "/eos/atlas/atlascerngroupdisk/phys-exotics/jdm/svjets-schannel/v6/v6.3/user.ebusch.";
	...
	vector<string> filetags = {"totalBKG", "515487", "515490", "515499", "515502", "515523", "515526"};
