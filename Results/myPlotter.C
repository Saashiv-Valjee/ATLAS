...
void myPlotter(){
	...
	string path = "/eos/atlas/atlascerngroupdisk/phys-exotics/jdm/svjets-schannel/v6/v6.1/user.ebusch.";
	...
	vector<string> filetags = {"QCDbkg", "Znunu", "515479", "515482", "515499", "515502", "515523", "515526"};
	...
	plotter.plot_error = false;
        plotter.output_file_tag ="v6p1_fatjet";
	...
	plotter.colors = {kBlack, kGray+2, kBlue+1, kAzure+7, kGreen+3, kSpring, kRed+1, kOrange-3, kPink+10, kPink+1, kYellow, kYellow-3  }; //1 background
	...
	//plotter.SaveOutputFile("test");
        plotter.SetPlots ( { P_mT_JJ, P_fatjet1_pt, P_fatjet1_C2} );
