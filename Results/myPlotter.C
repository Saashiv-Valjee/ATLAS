...
void myPlotter(){
	...
	vector<string> filetags = {"QCDtest.mc16e"};
	...
	plotter.plot_error = false;
        plotter.output_file_tag ="qcd_trigger";
	...
	plotter.colors = {kBlack, kOrange+10, kBlue+2, kGreen+1, kAzure+7, kGreen+2, kAzure+7, kBlue+2 }; //1 background
