...
#ifdef v8p1Class_cxx
v8p1Class::v8p1Class(TString fileName) : fChain(0) 
{
...
Int_t v8p1Class::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t v8p1Class::LoadTree(Long64_t entry)
{
...
void v8p1Class::Init(TTree *tree)
{
...
void v8p1Class::Show(Long64_t entry)
{
...
Int_t v8p1Class::Cut(Long64_t entry)
{
