...
eosPath = "root://eosatlas.cern.ch//eos/atlas/atlascerngroupdisk/phys-exotics/jdm/svjets-schannel/v9/v9.3/"
...
if __name__ == "__main__":
    ...
    for file_list in ["sig_bkg.txt"]:
        ...
        for filePath in files:
            ...
            os.system("echo 'initialdir = /afs/cern.ch/work/e/ebusch/public/SVJ/ana-exot-2021-19/condor/v9.3' >> submit.sub")
