...
eosPath = "root://eosatlas.cern.ch//eos/atlas/atlascerngroupdisk/phys-exotics/jdm/svjets-schannel/v11/v11.1/"
...
if __name__ == "__main__":
    ...
    for file_list in ["v11p1_condor_files.txt"]:
        ...
        for filePath in files:
            ...
            os.system("echo 'initialdir = /afs/cern.ch/work/e/ebusch/public/SVJ/ana-exot-2021-19/condor/v11.1' >> submit.sub")
