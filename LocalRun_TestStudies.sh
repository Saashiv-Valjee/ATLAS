...
parentsubmitdir="/eos/user/a/afaulkne/test/svj/XAODAnaHelper/run/"
...
echo "xAH_run.py --files ${infile} --inputList --nevents $nevents --config $configFile --submitDir ${parentsubmitdir}/$submitdir --log-level $loglevel $extra --force direct"
